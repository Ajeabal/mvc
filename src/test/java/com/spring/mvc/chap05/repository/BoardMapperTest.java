...
//    }
    ...
    @Test
    @DisplayName("게시물을 전체조회하면 1개의 게시물이 조회된다.")
    void findAllTest() {
        //given

        //when
//        List<Board> boardList = mapper.findAll(Search page);
        //then
//        assertEquals(1, boardList.size());
    ...
    @Test
    @DisplayName("20번 게시물을 단일조회하면 제목에 14이 포함되어 있어야 한다.")
    void findOneTest() {
        //given
        int boardNo = 30;
        //when
    ...
    @Test
    @DisplayName("20번 게시물을 삭제하고 다시 조회하면 조회되지 않아야 한다.")
    @Transactional
    @Rollback
    void deleteTest() {
        //given
