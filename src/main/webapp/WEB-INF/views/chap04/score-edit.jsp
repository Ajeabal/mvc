...
<div class="wrap">
    <section class="score-main">
        ...
        <form action="/score/edit" method="POST">
            <input id="name-tag" type="hidden" name="name">
            <input id="stuNum-tag" type="hidden" name="stuNum">
            <label>
            ...
            <button class="list-btn" type="submit">확인</button>
            <a class="list-btn" href="/score/detail?stuNum=${s.stuNum}">이전으로</a>
        </form>
    </section>
    <script>
        document.getElementById("name-tag").value = "${s.name}";
        document.getElementById("stuNum-tag").value = "${s.stuNum}";
    </script>
</div>
</body>
</html>
